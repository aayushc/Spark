...
public class part2 {
	  ...
	  public static void main(String[] args) throws Exception {
	    ...
	    JavaRDD<String> arcs = ctx.textFile("s3n://aayushc15619demo/project4input/inputpart2.txt");//s3n://s15-p42-part2/wikipedia_arcs");
	    JavaRDD<String> mapping = ctx.textFile("s3n://aayushc15619demo/project4input/mapping.txt");//"s3n://s15-p42-part2/wikipedia_mapping");
